...
/**
 * Aktivitas untuk mengedit yang ada atau membuat kata baru.
 */
public class EditWordActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Dapatkan data yang dikirim dari pemanggilan activity.
        Bundle extras = getIntent().getExtras();

        // Jika kita melewati konten, isikan untuk pengguna yang akan diedit.
        if (extras != null) {
